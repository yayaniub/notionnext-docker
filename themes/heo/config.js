const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://macblog.pgyu.org' },
    { title: '记录生活的每一刻', url: 'https://macmenos.pgyu.org' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '记录想法',
  HERO_TITLE_2: '与生活成长过程',
  HERO_TITLE_3: '',
  HERO_TITLE_4: '新版上线',
  HERO_TITLE_5: '欢迎来到我的博客👏',
  HERO_TITLE_LINK: 'https://macblog.pgyu.org',
  ...
  HERO_RECOMMEND_COVER: 'https://jihulab.com/images1/blog/-/raw/main/pictures/2023/10/2173150.jpg', // 英雄区右侧图片
